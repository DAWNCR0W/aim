...
class _$AppDatabase extends AppDatabase {
  ...
  LocalUserDao? _localUserDaoInstance;
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `LocalUser` (`id` TEXT NOT NULL, `password` TEXT NOT NULL, `phone` TEXT NOT NULL, `email` TEXT NOT NULL, PRIMARY KEY (`id`))');
  ...
  LocalUserDao get localUserDao {
    return _localUserDaoInstance ??= _$LocalUserDao(database, changeListener);
  }
}
...
class _$LocalUserDao extends LocalUserDao {
  ...
  Future<LocalUser?> getUser() async {
    return _queryAdapter.query('SELECT * FROM LocalUser LIMIT 1',
